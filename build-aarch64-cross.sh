...
docker cp dr_rustario_aarch64:/app/target/aarch64-unknown-linux-gnu/release/dr-rustario-vs-rustris $DEST

docker rm -f dr_rustario_aarch64

scp $DEST/dr-rustario-vs-rustris ark@10.0.0.117:/roms/ports/dr-rustario