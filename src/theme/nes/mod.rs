...
pub fn nes_theme<'a>(
    ...
    let options = RetroThemeOptions {
        ...
        sprites: VitaminSpriteSheetData::new(
            ...
            BLOCK_SIZE,
            0x40,
            DrSpriteSheetData::new(sprites::DR_THROW, 3),
            DrSpriteSheetData::new(sprites::DR_GAME_OVER, 1),
            DrSpriteSheetData::new(sprites::DR_VICTORY, 2),
            DrSpriteSheetData::new(sprites::DR_IDLE, 1),
        ),
        ...
        font: FontThemeOptions::simple(
            ...
            MetricSnips::zero_fill((92, 113), 9999999),
            MetricSnips::zero_fill((123, 134), 99),
            MetricSnips::zero_fill((123, 155), 99)
        ),
