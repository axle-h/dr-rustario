...
impl TetrisNeuralNetwork {
    ...
    /// This model has sacrificed some survival for prioritizing 4-line Tetris clears.
    pub fn tetris_clear_trained() -> Self {
    ...
    /// This model can play indefinitely on most seeds
    pub fn survival_trained() -> Self {
